...
- **外观**：深色、浅色、跟随系统；鲜明和马卡龙色系。内置磁贴主题色（包括旧项目中曾被误标为手动色的内置颜色）以及画笔、文字、高光、磁贴色卡会跟随色系；已有文字、高光和笔迹颜色保持原值，自定义磁贴颜色也保持原值。色卡使用白框和右上角勾选标记当前颜色；混合选区或不在当前色卡内的颜色不会误标为其他颜色。项目与文件操作在查看和编辑模式下均位于顶栏，项目名前显示文件夹图标，最近项目之间留有间隔。
