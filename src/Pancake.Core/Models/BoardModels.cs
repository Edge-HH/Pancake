...
public sealed class SubjectBoard : ObservableObject
{
    ...
    /// <summary>主题色以字符串保存，界面层按需转换成画刷颜色。</summary>
    public BoardColor AccentColor => BoardColor.Parse(_accentHex, DefaultAccentColor);

    public static BoardColor DefaultAccentColor { get; } = BoardColor.FromRgb(129, 140, 248);
